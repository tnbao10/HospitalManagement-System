					...
					<ul class="top-nav">
						...
						<li class="dropdown"><a href="#!" data-toggle="dropdown"
							...
							<ul class="dropdown-menu settings-menu">
								...
								<li><a href="${pageContext.request.contextPath}/admin?action=profile"><i class="icon-user"></i> Profile</a></li>
			...
			<section class="sidebar" id="sidebar-scroll">
				...
				<ul class="sidebar-menu">
					...
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="active treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/admin"> <i class="fas fa-home"></i><span>Home</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/admin?action=faculty-list"> <i class="fas fa-hospital"></i><span>Faculty Managment</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/admin?action=doctor-list"> <i class="fas fa-user-md"></i><span>Doctor Management</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/admin?action=patient-list"> <i class="ti-wheelchair"></i><span>Patient Management</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/admin?action=profile"> <i class="fas fa-user"></i><span>Admin's Profile</span>
					</a></li>
