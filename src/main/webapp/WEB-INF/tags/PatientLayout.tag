					...
					<ul class="top-nav">
						...
						<li class="dropdown"><a href="#!" data-toggle="dropdown"
							...
							<ul class="dropdown-menu settings-menu">
								...
								<li><a href="${pageContext.request.contextPath}/patient?action=profile"><i class="icon-user"></i> Profile</a></li>
			...
			<section class="sidebar" id="sidebar-scroll">
				...
				<ul class="sidebar-menu">
					...
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						...
						href="${pageContext.request.contextPath}/patient"> <i class="fas fa-notes-medical"></i><span>List of Faculty</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/patient?action=medical-history"> <i class="fas fa-file-medical"></i><span>Your Medical History</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/patient?action=make-appointment"> <i class="fas fa-book"></i><span>Make an appointment</span>
					</a></li>
					<li style="border-bottom: 1px solid #ddd; padding-bottom: 5px;"
						class="treeview"><a class="waves-effect waves-dark"
						href="${pageContext.request.contextPath}/patient?action=profile"> <i class="fas fa-user"></i><span>Your Profile</span>
					</a></li>
