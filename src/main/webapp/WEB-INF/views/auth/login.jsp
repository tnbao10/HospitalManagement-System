				...
				<div class="col-sm-12">
					<div class="login-card card-block">
						<form method="POST"
							...
							<h6 class="text-danger">${messageFail}</h6>

							<div class="row">
								<div class="col-md-12" style="margin-bottom: 15px;">
									<div>
										<label>Email</label> <input type="email"
											class="md-form-control" name="email" required="required" />
									</div>
								</div>
								<div class="col-md-12" style="margin-bottom: 15px;">
									<div>
										<label>Password</label> <input type="password"
											class="md-form-control" name="password" required="required" />
									</div>
								</div>
							...
							<div class="row">
								<div class="col-xs-10 offset-xs-1">
									<h6 class="text-success" style="text-align: center">${msgRegisterSuccess}</h6>
									<button type="submit"
							...
							<div class="col-sm-12 col-xs-12 text-center">
								<span class="text-muted">Don't have an account?</span> <a
									href="${pageContext.request.contextPath}/auth?action=register" class="f-w-600 p-l-5">Sign up Now</a>
							</div>
